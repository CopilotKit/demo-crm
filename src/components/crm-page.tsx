...
import { DocumentPointer, useMakeCopilotReadable, useMakeCopilotDocumentReadable } from '@copilotkit/react-core';
...
export function CrmPage() {
  ...
  useMakeCopilotReadable(callSummary, undefined, [salesReplyCategoryId], [])
      ...
      <div className="hidden border-r bg-gray-100/40 lg:block dark:bg-gray-800/40">
        <div className="flex h-full max-h-screen flex-col gap-2">
          ...
          <div className="flex-1 overflow-auto py-2">
            <div className="px-4">
              <h2 className="text-lg font-bold">Robert Masters & Sarah Smith</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">rmasters@ppnw.com</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">ssmith@ppnw.com</p>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Called on 12/01/2024</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Emailed on 11/01/2024</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Met in person on 10/01/2024</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <EmailSubjectTextarea emailSubject={emailSubject} setEmailSubject={setEmailSubject} salesReplyCategoryId={salesReplyCategoryId} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="message">Message</Label>
              <EmailBodyTextarea emailBody={emailBody} setEmailBody={setEmailBody} salesReplyCategoryId={salesReplyCategoryId} />
            </div>
            <div className="space-y-2">
