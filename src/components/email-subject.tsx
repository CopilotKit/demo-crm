  ...
  return (
    <CopilotTextarea
      ...
      autosuggestionsConfig={{
        textareaPurpose: "An email subject (title). Keep it SHORT AND SIMPLE! Written by a high-quality sales executive, who knows how to be PERSONIBLE, DIRECT, AND NON-SALESY. The specific context is A proposal for a prospective client contract - as a follow-up to a previous call.",
